...
import css from './BlockDefaultLandingHero.module.css';
...
const BlockDefaultLandingHero = props => {
  const {
    blockId,
    className,
    rootClassName,
    ...
    <BlockContainer id={blockId} className={classes}>
      ...
      {hasTextComponentFields ? (
        <div className={classNames(textClassName, css.text)}>
          <Field className={title} data={title} options={options} />
          <Field className={css.text} data={text} options={options} />
...
BlockDefaultLandingHero.defaultProps = {
  className: null,
  rootClassName: null,
  mediaClassName: null,
  textClassName: null,
...
BlockDefaultLandingHero.propTypes = {
