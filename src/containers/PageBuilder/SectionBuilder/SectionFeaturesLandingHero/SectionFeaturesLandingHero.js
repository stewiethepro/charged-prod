...
import css from './SectionFeaturesLandingHero.module.css';
...
// text [image]
// [image] text
const SectionFeaturesLandingHero = props => {
  const {
    sectionId,
    className,
    rootClassName,
...
SectionFeaturesLandingHero.defaultProps = {
  className: null,
  rootClassName: null,
  defaultClasses: null,
  textClassName: null,
...
SectionFeaturesLandingHero.propTypes = {
